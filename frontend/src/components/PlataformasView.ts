  ...
  return `
    <div class="space-y-5 animate-fadeIn">
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button id="plataforma-new-btn" class="btn-primary text-xs sm:text-sm">
        ...
        ` : plataformas.map(p => `
          <div class="cmdb-card-interactive p-5">
            ...
            <div class="flex items-center gap-1 mt-3 pt-3 border-t border-[#EDF0FF]">
              <button data-toggle-plataforma="${p.id}" data-current-estado="${p.estado}" class="p-1.5 text-slate-400 hover:text-amber-600 hover:bg-amber-50 rounded-lg transition" title="Cambiar estado">
